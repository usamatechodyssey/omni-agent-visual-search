...
class MongoProductConnector(BaseConnector):
    ...
    def __init__(self, credentials: Dict[str, str]):
        ...
        # NEW: Image Adapter/Mode (e.g., "cdn", "local", "mixed")
    ...
    def _get_all_images(self, item: dict) -> List[str]:
        ...
        # Helper to extract from a specific path
        def extract_from_path(path: str):
            ...
            # Navigate to the list level (e.g., "variants")
            for part in parts[:-1]:
            ...
            # Extract final URLs from the list
        ...
        if mode == "cdn":
            ...
            # Extract from both, de-duplicate if same URL exists
    ...
    def fetch_products(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for doc in cursor:
                ...
                # Extract all image URLs using multi-adapter logic
